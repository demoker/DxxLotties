...
- (BOOL)needsUpdateForFrame:(CGFloat)frame {
...
- (BOOL)updateWithFrame:(CGFloat)frame withModifierBlock:(void (^ _Nullable)(LOTAnimatorNode * _Nonnull))modifier forceLocalUpdate:(BOOL)forceUpdate {
